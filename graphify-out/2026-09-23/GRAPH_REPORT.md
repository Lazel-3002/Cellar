...
## Corpus Check
- 362 files · ~417,225 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4445 nodes · 10831 edges · 231 communities (191 shown, 40 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 254 edges (avg confidence: 0.74)
...
Cohesion: 0.10
Nodes (27): AgentPart, TaskStartOptions, Artifact, ArtifactSummary, AttachmentKind, AttachmentRef, ChatStreamEvent, ContextInfo (+19 more)
...
Cohesion: 0.11
Nodes (8): ToolProtocol, agentNoun(), chatTaskState(), hostOf(), joinText(), LiveRun, stableJson(), TaskRunner

### Community 4 - "engine.ts"
Cohesion: 0.07
Nodes (48): attachmentFromBytes(), attachmentRefs(), attachmentsFromPaths(), classifyFile(), cleanupOrphanAttachments(), extractPdfText(), IMAGE_TYPES, Row (+40 more)

### Community 5 - "run"
Cohesion: 0.14
Nodes (26): baseBlob(), branchExists(), branchSlug(), createWorktree(), currentBranch(), findMemoryFile(), git(), gitAvailable() (+18 more)
...
Cohesion: 0.20
Nodes (13): fitToContext(), messageTokens(), toTurns(), truncateMiddle(), ParsedImageTag, parseImageTags(), withImageTags(), branchPath() (+5 more)
...
Cohesion: 0.09
Nodes (17): buildDesignPrompt(), DesignPromptInput, attachPreview(), contentSchema, createArtboardTool, deleteArtboardTool, DESIGN_TOOLS, designId() (+9 more)
...
Cohesion: 0.10
Nodes (24): IpcEventMap, TaskNotice, DesignChangedEvent, MathChangedEvent, LoadProgressEvent, AnnotationBase, Book, BookChat (+16 more)

### Community 16 - "IpcInvokeMap"
Cohesion: 0.07
Nodes (33): ApprovalAction, ApprovalDecision, ApprovalRequest, CompactionPart, ConversationKind, ReasoningPart, TaskFile, TaskSource (+25 more)
...
Cohesion: 0.14
Nodes (16): expandToGroups(), imagesFromFiles(), AddArtboardButton(), Box, boxFor(), DesignCanvas(), Drag, elementBox() (+8 more)

### Community 23 - "SettingsPage.tsx"
Cohesion: 0.08
Nodes (9): ACCENTS, Code(), LANGUAGES, SECTIONS, SettingsPage(), SHORTCUTS, VARIANT_LABEL, Voice() (+1 more)

### Community 24 - "types/models.ts"
Cohesion: 0.06
Nodes (54): apply(), blanksFrom(), blanksInPdf(), cache, Glyph, IDENTITY, log, Matrix (+46 more)
...
### Community 27 - ".doScan"
Cohesion: 0.08
Nodes (18): addBlocksTool, blockSchema, calculateTool, deleteBlocksTool, diagramStepSchema, drawDiagramTool, drawFigureTool, elementSchema (+10 more)
...
Cohesion: 0.22
Nodes (5): joinReasoning(), TaskRunInput, TaskRunnerHooks, chat, ChatStore
...
Cohesion: 0.18
Nodes (13): ActiveGeneration, log, buildSystemPrompt(), chatToolGuidance(), cleanTitle(), fallbackTitle(), parseFollowUps(), supportsArtifactInstructions() (+5 more)
...
Cohesion: 0.05
Nodes (32): coworkGuidance, parseParamsBillions(), StreamEvent, ModelEntry, BUILTIN_PROVIDER_IDS, ProviderConfig, ProviderConfigInput, ProviderKind (+24 more)
...
Cohesion: 0.10
Nodes (38): blockElements(), cellValue(), chartTable(), createPptx(), createXlsx(), DOCUMENT_EXTENSIONS, DocumentOptions, DOCX_IMAGE_TYPES (+30 more)
...
Cohesion: 0.09
Nodes (37): pdfAvailable(), historyTokens(), AgentPromptInput, buildAgentPrompt(), compactionRequest(), autoApproveAction(), log, RepeatedCallLimitError (+29 more)

### Community 67 - "@fontsource-variable/inter"
Cohesion: 0.12
Nodes (24): CalcOptions, CalcResult, approxRational(), isRational(), AngleMode, checkPythagoras(), DerivativeInput, exactOf() (+16 more)
...
Cohesion: 0.17
Nodes (12): RoundOptions, FitResult, SideChatPrompt, argumentsObject(), OllamaChatLine, OllamaPs, OllamaPullProgress, OllamaShow (+4 more)

### Community 70 - "@playwright/test"
Cohesion: 0.20
Nodes (26): point(), value(), blockType(), FIGURE_KINDS, figureKindOf(), isObject(), LIMITS, Loose (+18 more)
...
Cohesion: 0.17
Nodes (22): textSvg(), text(), Atom, escapeHtml(), labelText(), mathToPlain(), prepare(), renderMath() (+14 more)

### Community 74 - "streamdown"
Cohesion: 0.04
Nodes (90): AppCommand, AppInfo, BackgroundStatus, EVENT_CHANNELS, EventChannel, eventChannelFlags, Handler, INVOKE_CHANNELS (+82 more)
...
Cohesion: 0.10
Nodes (24): throttle(), recommendedWhisperVariant(), ALL_VARIANTS, cleanTranscript(), CLI_NAMES, fetchReleases(), findCli(), installing (+16 more)
...
Cohesion: 0.10
Nodes (27): boundsSchema, registerBrowserHandlers(), tabId, url, clearDomainSession(), cookieUrl(), DIR, ensureDir() (+19 more)
...
Cohesion: 0.15
Nodes (12): FollowUpChips(), SideChatMessage, ask(), ChatRequest, FakeProvider, msg(), Provider, question() (+4 more)
...
Cohesion: 0.23
Nodes (13): deleteStoredConnector(), ensureOverride(), listStoredConnectors(), pluginOverrides(), record(), Row, saveStoredConnector(), sealRecord() (+5 more)
...
Cohesion: 0.09
Nodes (25): CHART_KINDS, clamp(), LAYOUT_NAMES, layoutContent, layoutElements(), layoutName, LAYOUTS, Raw (+17 more)
...
Cohesion: 0.08
Nodes (27): INIT_PROMPT, PermissionMode, MessageModelInfo, ProjectIndexStatus, CodeMode, ModelRef, CronPreview, ReminderSpec (+19 more)
...
Cohesion: 0.06
Nodes (48): connectorTool(), connectorToolName(), connectorTools(), diagnosticsTool, forgetTool, objectSchema(), readChatTool, readSkillFileTool (+40 more)

### Community 102 - "orchestrator.ts"
Cohesion: 0.11
Nodes (37): calculate(), evaluationSteps(), measureOf(), prettyMeasure(), formatExact(), Rational, ALIASES, canonicalFunction() (+29 more)
...
Cohesion: 0.06
Nodes (25): BrowserService, getWindow(), normalizeUrl(), EMPTY, historyOf(), LiveReply, newRequestId(), requestMessages() (+17 more)

### Community 110 - "downloadFile"
Cohesion: 0.20
Nodes (13): downloadFile(), DownloadOptions, fileSize(), hashExisting(), EXE_NAMES, findPiper(), installing, PIPER_VOICES (+5 more)

### Community 111 - "design/store.ts"
Cohesion: 0.10
Nodes (11): closeDatabase(), db(), migrate(), openDatabase(), migrations, MemoryCategory, userData, userData (+3 more)
...
Cohesion: 0.06
Nodes (47): DownloadManager, computeQuantFit(), fitCache, fitInflight, fitWaiters, hfHeaders(), hfJson(), quantFit() (+39 more)

### Community 119 - "@types/react-dom"
Cohesion: 0.14
Nodes (7): check(), OutputBuffer, registerTerminalHandlers(), releaseExitedPty(), TerminalManager, Emitted, waitFor()
...
Cohesion: 0.11
Nodes (51): builtInCommands(), changed(), commandSlug(), customCommands(), deleteCommand(), expandCommand(), expandTemplate(), getCommand() (+43 more)
...
Cohesion: 0.06
Nodes (55): installPdfRenderer(), installTaskNotifications(), log, setGradientRasterizer(), setPdfRenderer(), setSvgRasterizer(), browser, installBrowser() (+47 more)
...
Cohesion: 0.14
Nodes (33): BOM, byPath(), countable(), readWorkspaceFile(), snapshotChangeSet(), snapshotFileDiff(), WriteOptions, buildDiff() (+25 more)

### Community 140 - "streams.ts"
Cohesion: 0.09
Nodes (21): BINARY_EXTENSIONS, count(), describeWrite(), editFileTool, globTool, grepTool, IMAGE_EXTENSIONS, isBinary() (+13 more)
...
Cohesion: 0.12
Nodes (20): ChartElement, ChartKind, ChartSeries, DesignElementType, DesignExportFormat, DesignFormat, DesignTransition, ElementBase (+12 more)
...
Cohesion: 0.16
Nodes (15): ThemePanel(), clampSize(), COLOR_TOKENS, FontCategory, FONTS, FORMAT_DEFAULTS, hex6(), luminance() (+7 more)
...
Cohesion: 0.22
Nodes (18): attachmentImage(), artboardPreview(), ensureSession(), exportDesign(), ExportTarget, fileSafe(), imageUrls(), rasterizeGradient() (+10 more)
...
Cohesion: 0.15
Nodes (21): ChartRenderOptions, chartSvg(), clamp(), formatValue(), niceScale(), normalizeChart(), r1(), truncate() (+13 more)

### Community 160 - "math/actions.ts"
Cohesion: 0.17
Nodes (13): PREVIEW_SCHEME_PRIVILEGES, ARTIFACT_CSP, escapeScript(), handleArtifactProtocol(), registerArtifactScheme(), renderArtifactDocument(), RUNTIME_FILES, handleVizProtocol() (+5 more)
...
### Community 168 - "react"
Cohesion: 0.16
Nodes (18): BlockBase, DerivationBlock, DerivationStep, DiagramBlock, FigureBlock, FigureKind, FormulaBlock, MathBlockType (+10 more)

### Community 169 - "electron-vite"
Cohesion: 0.13
Nodes (32): CATEGORY_KEYWORDS, computeRelevanceScore(), computeTopicVectorScores(), computeVectorSimilarity(), getTopicById(), listAllExplicitMemories(), listAllMemoryTopics(), log (+24 more)
...
Cohesion: 0.15
Nodes (11): ToolPart, ChatRequest, conversation(), entry, fake, FakeProvider, fixture, message() (+3 more)
...
Cohesion: 0.35
Nodes (3): prepareDesignSession(), newId(), prepareMathSession()

### Community 183 - "vscode-languageserver-protocol"
Cohesion: 0.12
Nodes (28): attachCloseToTray(), backgroundActive(), createMain(), getMain(), hideQuickEntry(), iconPath(), installBackground(), isQuitting() (+20 more)
...
Cohesion: 0.12
Nodes (5): seedBuiltinProviders(), log, ProviderRegistry, withTimeout(), Provider
...
Cohesion: 0.38
Nodes (9): dayKey(), formatHour(), getUsageStats(), mean(), median(), RANGE_DAYS, startOfDay(), streaks() (+1 more)
...
Cohesion: 0.53
Nodes (5): defaultContext(), pagesText(), pickPages(), pageSizes(), pagesLines()
...
Cohesion: 0.17
Nodes (12): defaultPolicy(), log, renderToolResult(), toolPolicy(), toolResultImages(), withTimeout(), authUrlFor(), closeOAuthServer() (+4 more)
...
Cohesion: 0.33
Nodes (11): addMemory(), changed(), clean(), clearMemories(), findMemory(), listMemories(), memoryHandle(), memoryPrompt() (+3 more)
...
Cohesion: 0.38
Nodes (6): artifactsForConversation(), listArtifacts(), memory, Row, saveArtifactsFromMessage(), toArtifact()
...
## Knowledge Gaps
- **1076 isolated node(s):** `shared`, `baseCsp`, `name`, `productName`, `version` (+1071 more)
...
- **Why does `value()` connect `@playwright/test` to `DownloadManager`, `queries.ts`, `openai-compat.ts`, `ArtifactPanel`, `fetchWithTimeout`, `code-session.test.ts`, `SettingsPage.tsx`, `@vitejs/plugin-react`, `OpenAIServerProvider`, `charts.ts`, `MathPage.tsx`, `CellarBridge`, `DiscoverPage.tsx`, `ModelsPage.tsx`, `@xterm/addon-web-links`, `PreviewPane.tsx`, `electron`, `electron-builder`, `@fontsource-variable/inter`, `@fontsource-variable/source-serif-4`, `tailwind-merge`, `@vitejs/plugin-react`, `Workspace`, `SideChat.tsx`, `TerminalPane.tsx`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `paths()` connect `DownloadManager` to `hf-api.ts`, `ChatOrchestrator`, `engine.ts`, `run`, `.resolve`, `openai-compat.ts`, `DownloadManager`, `router.tsx`, `types/models.ts`, `LmStudioProvider`, `math/actions.ts`, `Provider`, `network.test.ts`, `.update`, `@playwright/test`, `@streamdown/mermaid`, `vscode-languageserver-protocol`, `ArtifactPanel.tsx`, `electron-vite`, `.content`, `memory.test.ts`, `sucrase`, `@types/react`, `typescript`, `zustand`, `tools/types.ts`, `SideChat.tsx`, `downloadFile`, `monaco-editor`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `errorMessage()` connect `tailwindcss` to `hf-api.ts`, `DownloadManager`, `ChatOrchestrator`, `run`, `.resolve`, `orchestrator.ts`, `fetchWithTimeout`, `types/models.ts`, `OpenAIServerProvider`, `ProviderRegistry`, `Provider`, `network.test.ts`, `.update`, `window.ts`, `electron-vite`, `radix-ui`, `@playwright/test`, `vscode-languageserver-protocol`, `PreviewPane.tsx`, `electron-vite`, `artifact-protocol.ts`, `radix-ui`, `memory.test.ts`, `sucrase`, `@tailwindcss/browser`, `tools/types.ts`, `SideChat.tsx`, `downloadFile`, `monaco-editor`, `TerminalPane.tsx`, `@types/react-dom`?**
