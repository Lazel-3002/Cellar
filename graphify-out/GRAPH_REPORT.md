# Graph Report - Cellar  (2026-09-24)

## Corpus Check
- 375 files · ~444,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4804 nodes · 11697 edges · 259 communities (195 shown, 64 thin omitted)
...
### Community 6 - "scripts"
Cohesion: 0.11
Nodes (19): croner, electron-updater, extract-zip, dependencies, croner, electron-updater, extract-zip, pdf-lib (+11 more)
...
Cohesion: 0.09
Nodes (27): IpcEventMap, TaskNotice, TerminalDataEvent, TerminalExitEvent, ConnectorStatus, DesignChangedEvent, MathChangedEvent, LoadProgressEvent (+19 more)
...
Cohesion: 0.10
Nodes (33): canonicalFields(), clamp(), color(), FORMATS, gradient(), imageCrop(), imageFilters(), KEY_ALIASES (+25 more)
...
Cohesion: 0.04
Nodes (113): INIT_PROMPT, AppCommand, AppInfo, BackgroundStatus, EVENT_CHANNELS, EventChannel, eventChannelFlags, Handler (+105 more)
...
Cohesion: 0.04
Nodes (71): callTool, moduleId, normalizeCallArgs(), connectorTool(), connectorToolName(), connectorTools(), diagnosticsTool, forgetTool (+63 more)
...
Cohesion: 0.25
Nodes (8): ANSI, ESC, killTree(), runCommand, runShell(), ShellOptions, ShellResult, collect()
...
Cohesion: 0.12
Nodes (19): ThemePanel(), clampSize(), COLOR_TOKENS, FontCategory, FONTS, FORMAT_DEFAULTS, gradientStops(), hex6() (+11 more)
...
Cohesion: 0.14
Nodes (22): ChartRenderOptions, chartSvg(), clamp(), formatValue(), niceScale(), normalizeChart(), r1(), truncate() (+14 more)
