...
export interface ToolContext {
  ...
  /** How any approval-requiring tool call is handled this turn; see AppSettings.approvalMode. */
  approvalMode?: 'manual' | 'auto' | 'bypass';
  /** 'auto' approval mode: a quick, context-free model call reviews one pending tool call. */
  autoApprove?(request: ApprovalRequest): Promise<{ allow: boolean; note?: string }>;
}
